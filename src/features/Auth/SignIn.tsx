...
// import { displayBlock, displayFlex, remember, styleFont } from '../css/funcs';

// function goToSignUp(checkUser, value) {
//   checkUser(value);
// }
...
//       Cookies.set(COOKIE_KEY, request.token, {
//         expires: remember ? data.number * 7 : 1,
//       });
...
//             onClick={() => goToSignUp(checkUser, 'reset')}
//           >
//             Forgot Password?
//           </span>
//         </div>
...
//             id="sign-in"
//             style={styleFont}
//             onClick={() => goToSignUp(checkUser, 'up')}
//           >
//             Sign up
//           </span>
//         </p>
